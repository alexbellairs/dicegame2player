...
if ((currentPlayer = 1)) {
  areaPlayer1.style.backgroundColor = "#FF4E33";
  imageContainer1.style.backgroundColor = "#4C5B5C";
  scoreContainer1.style.backgroundColor = "#4C5B5C";
  rollText2.textContent = "Player 1 is rolling";
} else if ((currentPlayer = 2)) {
  areaPlayer2.style.backgroundColor = "#FF4E33";
  imageContainer2.style.backgroundColor = "#4C5B5C";
  scoreContainer2.style.backgroundColor = "#4C5B5C";
...
passPlayer1.addEventListener("click", () => {
  if (currentPlayer == 1) {
    ...
    areaPlayer1.style.backgroundColor = "#FF715B";
    imageContainer1.style.backgroundColor = "#4C5B5C";
    scoreContainer1.style.backgroundColor = "#4C5B5C";
    areaPlayer2.style.backgroundColor = "#FF4E33";
    imageContainer2.style.backgroundColor = "#4C5B5C";
...
passPlayer2.addEventListener("click", () => {
  if (currentPlayer == 2) {
    currentPlayer = 1;
    areaPlayer2.style.backgroundColor = "#FF715B";
    imageContainer2.style.backgroundColor = "#4C5B5C";
    scoreContainer2.style.backgroundColor = "#4C5B5C";
    areaPlayer1.style.backgroundColor = "#FF4E33";
    imageContainer1.style.backgroundColor = "#4C5B5C";
